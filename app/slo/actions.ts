...
export async function fetchDoraIncidents(app: string, limit: number = 50): Promise<ApiResponse<Incident[]>> {
    return speiderhyttaFetch<Incident[]>(Routes.doraIncidents(app, limit), `incidents for ${app}`)
}
